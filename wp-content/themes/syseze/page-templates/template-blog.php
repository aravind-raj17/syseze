 ...
 *
 * Lists posts in the SysEze layout.
 * Set this as the "Posts page" under Settings ▸ Reading, OR assign it to a page called Blog.
 *
 * @package SysEze
 */
...
// Run a fresh query (works whether this is assigned to a static page or to the blog index).
	...
	<div class="container">
		...
		<?php else : ?>
			<div class="section-head reveal">
				<h2>No posts yet</h2>
				<p>Once you publish your first article in <strong>Posts</strong>, it will appear here.</p>
			</div>
		<?php endif; ?>
	</div>
</section>
